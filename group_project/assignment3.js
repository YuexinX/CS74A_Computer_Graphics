...
export class Assignment3 extends Scene {
    constructor() {
        ...
        this.ball_position = vec3(0, 19, 5);
        this.ball_velocity = vec3(0, -1, 0); 
    }
    ...
    display(context, program_state) {
        ...
        //let ball_transform_2 = Mat4.identity();
        let fall_factor = 3.5 * Math.sin(Math.PI * t % 3);
        ball_transform = ball_transform.times(Mat4.scale(0.4,0.4,0.4))
            .times(Mat4.translation(0,19-fall_factor,5));
